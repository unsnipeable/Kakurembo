package matanku.kakurembo.util.serialization;

import matanku.kakurembo.HideAndSeek;
import matanku.kakurembo.util.CC;
...
public class LocationSerialization {
    ...
    public static String toReadable(Location location) {
        ...
        return location.getWorld().getName() + " " + HideAndSeek.DECIMAL.format(location.getX()) + " " + HideAndSeek.DECIMAL.format(location.getY()) + " " + HideAndSeek.DECIMAL.format(location.getZ()) + " " + HideAndSeek.DECIMAL.format(location.getYaw()) + " " + HideAndSeek.DECIMAL.format(location.getPitch());
    }
}
