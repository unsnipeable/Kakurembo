    ...
    public void onRun() {
        ...
        if (tick % 60 == 0) {
            for (GamePlayer gamePlayer : game.getPlayers().values()) {
                Manager.getDataManager(CoinDataManager.class).addPlayerInfoInteger(gamePlayer.getPlayer().getUniqueId().toString(), 10, DataEnum.DataManagerType.ADD);
