...
public abstract class DataManager implements IDataManager {
    ...
    public void addPlayerInfoInteger(String playerName, int value, DataEnum.DataManagerType dmt) {
    ...
    public void addPlayerInfoString(String playerName, String value, DataEnum.DataManagerType dmt) {
